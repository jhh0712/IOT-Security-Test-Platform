...
char *Decrypt(unsigned char state[0x04][0x04], unsigned char CipherKey[0x04][0x04])
{
	char *temp = (char *)malloc(sizeof(char)* 16);
	
	unsigned char Init_Key[0x04][0x04];
